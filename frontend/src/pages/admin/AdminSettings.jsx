      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white text-2xl font-bold">
              {user?.name?.charAt(0)}
            </div>
            <div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-white font-semibold">Email Configuration</h3>
          </div>
          <div className="space-y-3 text-sm">
            {[
              ...
              <div key={label} className="flex justify-between">
                <span className="text-gray-400">{label}</span>
                <span className="text-white font-medium text-xs font-mono">{value}</span>
              </div>
            ))}
          </div>
        </div>
