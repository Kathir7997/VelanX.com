...
export default function DriverPODHistory() {
  ...
  if (isLoading) return <div className="text-gray-400">Loading POD History...</div>;
    ...
    <div className="space-y-6">
      ...
      {pods?.length === 0 ? (
        <div className="glass-card p-12 text-center flex flex-col items-center">
          ...
          <h3 className="text-xl text-white font-semibold">No PODs Found</h3>
          <p className="text-gray-400">You haven't submitted any proofs of delivery yet.</p>
        </div>
      ) : (
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                    ...
                    <div className="w-full h-32 bg-dark-800 rounded-lg border border-dark-600 overflow-hidden">
                      {pod.productPhoto ? (
