  ...
  return (
    <div>
      ...
      <div className="glass-card p-12 text-center">
        ...
        <p className="text-gray-900 font-medium">Reports Coming Soon</p>
        <p className="text-gray-700 text-sm mt-1">Detailed warehouse analytics and inventory reports</p>
      </div>
    </div>
  );
}
