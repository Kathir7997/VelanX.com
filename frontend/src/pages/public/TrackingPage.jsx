    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-16 px-6">
      <div className="container-max mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="text-gray-700 text-lg">Enter your tracking number for real-time updates</p>
        </motion.div>
          ...
          <div className="glass-card p-2 flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="input-field pl-11 bg-transparent border-0 focus:border-0 text-gray-900 placeholder-gray-400"
        ...
        {isLoading && (
          <div className="glass-card p-12 text-center text-gray-800 max-w-2xl mx-auto">Searching...</div>
        )}
        ...
        {error && (
          <div className="glass-card p-12 text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-700 text-sm mt-1">Check the tracking number and try again.</p>
          </div>
        )}
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="bg-dark-800/60 rounded-xl p-3">
                  <p className="text-gray-800 mb-0.5 flex items-center gap-1"><MapPin size={11} /> From</p>
                  <p className="text-gray-900">{shipment.pickupAddress?.city}, {shipment.pickupAddress?.state}</p>
                </div>
                <div className="bg-dark-800/60 rounded-xl p-3">
                  <p className="text-gray-800 mb-0.5 flex items-center gap-1"><MapPin size={11} /> To</p>
                  ...
                  return (
                    <div key={key} className="flex items-start gap-4 mb-5 last:mb-0">
                      <div className="flex flex-col items-center">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${done ? 'bg-primary-500' : 'bg-gray-200 border border-black/10'}`}>
                          <Icon size={18} className={done ? 'text-gray-900' : 'text-gray-600'} />
                        </div>
                        {i < STATUS_STEPS.length - 1 && <div className={`w-0.5 flex-1 mt-1 min-h-[20px] ${done ? 'bg-primary-500' : 'bg-black/5'}`} />}
                      </div>
                      <div className="pt-2">
                        <p className={`font-medium text-sm ${done ? 'text-gray-900' : 'text-gray-600'}`}>{label}</p>
