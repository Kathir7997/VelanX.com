    ...
    <div className="min-h-screen pt-24 pb-16 px-6">
      <div className="container-max mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">Redefining logistics management with intelligent technology and enterprise-grade reliability.</p>
        </motion.div>
        <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">VelanX was founded with a simple mission: make logistics management as seamless and transparent as possible for every stakeholder — from the customer placing a shipment to the driver delivering it.</p>
            <p className="text-gray-700 leading-relaxed">We built a platform that handles the complete shipment lifecycle, with role-specific dashboards, real-time tracking, and powerful analytics that give business owners the insights they need to grow.</p>
          </motion.div>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <motion.div key={title} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 * i + 0.3 }} className="glass-card p-4">
                ...
                <p className="text-gray-800 text-xs mt-0.5">{desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700">VelanX is built by a passionate team of engineers dedicated to logistics innovation.</p>
        </div>
      </div>
    </div>
  );
